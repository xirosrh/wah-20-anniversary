...
enum NationalDexOrder
{
    ...
    // Boo
    NATIONAL_DEX_MOLIKAI,
    NATIONAL_DEX_MICAEL,
    NATIONAL_DEX_DIRAEI,
    NATIONAL_DEX_OSHAWOTT_X,
    ...
    NATIONAL_DEX_LATIKEN,
    NATIONAL_DEX_VENUSAUR_C,
    NATIONAL_DEX_CHARIZARD_C,
    NATIONAL_DEX_BLASTOISE_C,
    NATIONAL_DEX_GRENINJA_R,
    NATIONAL_DEX_ARMORED_MEWTWO,
};
...
#define JOHTO_DEX_COUNT     NATIONAL_DEX_CELEBI
    ...
    #define NATIONAL_DEX_COUNT  NATIONAL_DEX_ARMORED_MEWTWO
