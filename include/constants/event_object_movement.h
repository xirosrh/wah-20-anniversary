...
#define MOVEMENT_ACTION_CLIMB_STAIRS_DOWN              0xCE
#define MOVEMENT_ACTION_CLIMB_STAIRS_UP                0xCF
#define MOVEMENT_ACTION_CLIMB_STAIRS_FACE_DOWN         0xD0
#define MOVEMENT_ACTION_CLIMB_STAIRS_FACE_UP           0xD1
#define MOVEMENT_ACTION_CLIMB_STAIRS_FACE_LEFT         0xD2
#define MOVEMENT_ACTION_CLIMB_STAIRS_FACE_RIGHT        0xD3
...
#define ANIM_CLIMB_STAIRS_DOWN       (ANIM_RUN_EAST + 1)
#define ANIM_CLIMB_STAIRS_UP         (ANIM_RUN_EAST + 2)
#define ANIM_CLIMB_STAIRS_FACE_DOWN  (ANIM_RUN_EAST + 3)
#define ANIM_CLIMB_STAIRS_FACE_UP    (ANIM_RUN_EAST + 4)
#define ANIM_CLIMB_STAIRS_FACE_LEFT  (ANIM_RUN_EAST + 5)
#define ANIM_CLIMB_STAIRS_FACE_RIGHT (ANIM_RUN_EAST + 6)
