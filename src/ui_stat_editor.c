...
static const u8 sText_MenuActual[] = _("Current");
...
static void Task_ChooseMonForEvsIvsEditor(u8 taskId)
{
    if (!gPaletteFade.active)
    {
        CleanupOverworldWindowsAndTilemaps();
...
void ChooseMonForEvsIvsEditor(void)
{
    LockPlayerFieldControls();
    CreateTask(Task_ChooseMonForEvsIvsEditor, 10);
