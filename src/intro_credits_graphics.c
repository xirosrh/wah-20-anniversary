...
// Intro credits graphics removed - stub data
static const u16 sGrass_Pal[]             = {0};
static const u16 sGrassSunset_Pal[]       = {0};
static const u16 sGrassNight_Pal[]        = {0};
static const u32 sGrass_Gfx[]             = {0};
static const u32 sGrass_Tilemap[]         = {0};
static const u16 sCloudsBg_Pal[]          = {0};
static const u16 sCloudsBgSunset_Pal[]    = {0};
static const u32 sCloudsBg_Gfx[]          = {0};
static const u32 sCloudsBg_Tilemap[]      = {0};
static const u16 sClouds_Pal[]            = {0};
static const u16 sCloudsSunset_Pal[]      = {0};
static const u32 sClouds_Gfx[]            = {0};
static const u16 sTrees_Pal[]             = {0};
static const u16 sTreesSunset_Pal[]       = {0};
static const u32 sTrees_Gfx[]             = {0};
static const u32 sTrees_Tilemap[]         = {0};
static const u16 sTreesSmall_Pal[]        = {0};
static const u32 sTreesSmall_Gfx[]        = {0};
static const u16 sHouses_Pal[]            = {0};
static const u32 sHouses_Gfx[]            = {0};
static const u16 sHouseSilhouette_Pal[]   = {0};
static const u32 sHouses_Tilemap[]        = {0};
static const u32 sHouseSilhouette_Gfx[]   = {0};
static const u16 sBrendanCredits_Pal[]    = {0};
static const u32 sBrendanCredits_Gfx[]    = {0};
static const u16 sMayCredits_Pal[]        = {0};
static const u16 sUnused[0xF0]            = {0};
static const u32 sMayCredits_Gfx[]        = {0};
static const u32 sBicycle_Gfx[]           = {0};
static const u16 sLatios_Pal[]            = {0};
static const u32 sLatios_Gfx[]            = {0};
static const u16 sLatias_Pal[]            = {0};
static const u32 sLatias_Gfx[]            = {0};
