...
// Graphics removed - see commit 5b5df4a283
// Stubbed with empty arrays to maintain code compatibility
static const u16 sGrass_Pal[16]           = {0};
static const u16 sGrassSunset_Pal[16]     = {0};
static const u16 sGrassNight_Pal[16]      = {0};
static const u32 sGrass_Gfx[1]            = {0};
static const u32 sGrass_Tilemap[1]        = {0};
static const u16 sCloudsBg_Pal[16]        = {0};
static const u16 sCloudsBgSunset_Pal[16]  = {0};
static const u32 sCloudsBg_Gfx[1]         = {0};
static const u32 sCloudsBg_Tilemap[1]     = {0};
static const u16 sClouds_Pal[16]          = {0};
static const u16 sCloudsSunset_Pal[16]    = {0};
static const u32 sClouds_Gfx[1]           = {0};
static const u16 sTrees_Pal[16]           = {0};
static const u16 sTreesSunset_Pal[16]     = {0};
static const u32 sTrees_Gfx[1]            = {0};
static const u32 sTrees_Tilemap[1]        = {0};
static const u16 sTreesSmall_Pal[16]      = {0};
static const u32 sTreesSmall_Gfx[1]       = {0};
static const u16 sHouses_Pal[16]          = {0};
static const u32 sHouses_Gfx[1]           = {0};
static const u16 sHouseSilhouette_Pal[16] = {0};
static const u32 sHouses_Tilemap[1]       = {0};
static const u32 sHouseSilhouette_Gfx[1]  = {0};
static const u16 sBrendanCredits_Pal[16]  = {0};
static const u32 sBrendanCredits_Gfx[1]   = {0};
static const u16 sMayCredits_Pal[16]      = {0};
static const u16 sUnused[0xF0]            = {0};
static const u32 sMayCredits_Gfx[1]       = {0};
static const u32 sBicycle_Gfx[1]          = {0};
static const u16 sLatios_Pal[16]          = {0};
static const u32 sLatios_Gfx[1]           = {0};
static const u16 sLatias_Pal[16]          = {0};
static const u32 sLatias_Gfx[1]           = {0};
