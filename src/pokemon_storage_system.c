...
{
    [OPTION_WITHDRAW]   = {COMPOUND_STRING("WITHDRAW POKéMON"), COMPOUND_STRING("Move Pokémon stored in Boxes\nto your party.")},
    [OPTION_DEPOSIT]    = {COMPOUND_STRING("DEPOSIT POKéMON"), COMPOUND_STRING("Store Pokémon from your party in Boxes.")},
    [OPTION_MOVE_MONS]  = {COMPOUND_STRING("MOVE POKéMON"),    COMPOUND_STRING("Organize the Pokémon in Boxes\nand your party.")},
...
{
    [MSG_EXIT_BOX]             = {COMPOUND_STRING("Exit the Box?"),            MSG_VAR_NONE},
    ...
    [MSG_JUMP_TO_WHICH_BOX]    = {COMPOUND_STRING("Which Box do you want to jump to?"),       MSG_VAR_NONE},
    ...
    [MSG_RELEASE_POKE]         = {COMPOUND_STRING("Do you want to release this Pokémon?"), MSG_VAR_NONE},
    [MSG_WAS_RELEASED]         = {COMPOUND_STRING("{DYNAMIC 0} was released."),     MSG_VAR_PKMN_WAS_RELEASED},
    [MSG_BYE_BYE]              = {COMPOUND_STRING("Bye-bye, {DYNAMIC 0}!"),           MSG_VAR_BYE_BYE_PKMN},
    ...
    [MSG_HOLDING_POKE]         = {COMPOUND_STRING("You're already holding a Pokémon!"),        MSG_VAR_NONE},
    [MSG_WHICH_ONE_WILL_TAKE]  = {COMPOUND_STRING("Which one do you want to take?"),         MSG_VAR_NONE},
    [MSG_CANT_RELEASE_EGG]     = {COMPOUND_STRING("You can't release an Egg."),    MSG_VAR_NONE},
    [MSG_CONTINUE_BOX]         = {COMPOUND_STRING("Make more changes?"),MSG_VAR_NONE},
    ...
    [MSG_GIVE_TO_MON]          = {COMPOUND_STRING("Give it to a Pokémon?"),            MSG_VAR_NONE},
    [MSG_PLACED_IN_BAG]        = {COMPOUND_STRING("Placed the item in the Bag."),    MSG_VAR_ITEM_NAME},
    [MSG_BAG_FULL]             = {COMPOUND_STRING("The Bag is full."),        MSG_VAR_NONE},
    [MSG_PUT_IN_BAG]           = {COMPOUND_STRING("Put the item in the Bag?"),  MSG_VAR_NONE},
    ...
    [MSG_CANT_STORE_MAIL]      = {COMPOUND_STRING("You can't store Mail!"),    MSG_VAR_NONE},
};
