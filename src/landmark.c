...
static const struct Landmark Landmark_MrBrineysCottage = {COMPOUND_STRING("MR. BRINEY'S HOUSE"), FLAG_LANDMARK_MR_BRINEY_HOUSE};
...
static const struct Landmark Landmark_OldLadysRestShop = {COMPOUND_STRING("OLD LADY'S REST"), FLAG_LANDMARK_OLD_LADY_REST_SHOP};
static const struct Landmark Landmark_Desert = {COMPOUND_STRING("DESERT"), -1};
static const struct Landmark Landmark_WinstrateFamily = {COMPOUND_STRING("WINSTRATE FAMILY"), FLAG_LANDMARK_WINSTRATE_FAMILY};
...
static const struct Landmark Landmark_WeatherInstitute = {COMPOUND_STRING("WEATHER INST."), -1};
static const struct Landmark Landmark_MeteorFalls = {COMPOUND_STRING("METEOR FALLS"), -1};
static const struct Landmark Landmark_TunnelersRestHouse = {COMPOUND_STRING("TUNNELER'S HOUSE"), FLAG_LANDMARK_TUNNELERS_REST_HOUSE};
...
static const struct Landmark Landmark_SafariZoneEntrance = {COMPOUND_STRING("SAFARI ENTRANCE"), -1};
