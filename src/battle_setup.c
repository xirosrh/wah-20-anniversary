...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_WILTON] = REMATCH(TRAINER_WAH_COLLABORATOR_GOSUTO, TRAINER_WAH_COLLABORATOR_CACO_1, TRAINER_WAH_COLLABORATOR_CACO_2, TRAINER_WAH_COLLABORATOR_CACO_3, TRAINER_WILTON_5, MAP_ROUTE111),
