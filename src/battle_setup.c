...
{
    [REMATCH_ROSE] = REMATCH(TRAINER_WAH_ADMIN_EING_MAIN, TRAINER_WAH_ADMIN_TOKYN_ALTERNATIVE, TRAINER_WAH_ADMIN_WAR_MAIN, TRAINER_WAH_ADMIN_WAR_ALTERNATIVE, TRAINER_WAH_ADMIN_JAVI4315_MAIN, MAP_ROUTE118),
    [REMATCH_ANDRES] = REMATCH(TRAINER_ANDRES_1, TRAINER_ANDRES_2, TRAINER_ANDRES_3, TRAINER_ANDRES_4, TRAINER_ANDRES_5, MAP_ROUTE105),
    [REMATCH_DUSTY] = REMATCH(TRAINER_WAH_ADMIN_JAVS_MAIN, TRAINER_WAH_ADMIN_JAVI4315_ALTERNATIVE, TRAINER_WAH_ADMIN_JAVS_ALTERNATIVE, TRAINER_WAH_ADMIN_XIROS_MAIN, TRAINER_WAH_ADMIN_XIROS_ALTERNATIVE, MAP_ROUTE111),
    ...
    [REMATCH_WILTON] = REMATCH(TRAINER_WAH_COLLABORATOR_GOSUTO, TRAINER_WAH_COLLABORATOR_CACO_1, TRAINER_WAH_COLLABORATOR_CACO_2, TRAINER_WAH_COLLABORATOR_CACO_3, TRAINER_WAH_TRANSLATOR_RAIZEN, MAP_ROUTE111),
...
enum BattleTransition GetTrainerBattleTransition(void)
{
    ...
    if (trainerClass == TRAINER_CLASS_TEAM_MAGMA
        ...
        || trainerClass == TRAINER_CLASS_COLLABORATOR)
