...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_DUSTY] = REMATCH(TRAINER_WAH_ADMIN_JAVS_MAIN, TRAINER_WAH_ADMIN_JAVI4315_ALTERNATIVE, TRAINER_WAH_ADMIN_JAVS_ALTERNATIVE, TRAINER_DUSTY_4, TRAINER_DUSTY_5, MAP_ROUTE111),
