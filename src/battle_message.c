...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNCUTSATTACKWITH]                   = COMPOUND_STRING("¡{B_SCR_ABILITY} de {B_SCR_NAME_WITH_PREFIX} bajó el Ataque de {B_DEF_NAME_WITH_PREFIX}!"), //En gen 5+, no hay popup de habilidad
    ...
    [STRINGID_EXPLOSIVEPULP_DMG]                    = COMPOUND_STRING("¡{B_ATK_NAME_WITH_PREFIX} ha resultado herido por la pulpa explosiva!"),
