...
static const u8 sCondMsg02[] = _("{STR_VAR_1} spouted fire and roared.");
static const u8 sCondMsg03[] = _("{STR_VAR_1} is producing fire\nwith great energy!");
static const u8 sCondMsg04[] = _("{STR_VAR_1} spat fire!");
static const u8 sCondMsg05[] = _("{STR_VAR_1} is breathing flames\nwith great energy!");
static const u8* const sFireTexts[] = {sCondMsg02, sCondMsg03, sCondMsg04, sCondMsg05, NULL};
static const u8 sCondMsg06[] = _("{STR_VAR_1} is staring at\nthe POKéMON LEAGUE.");
static const u8 sCondMsg07[] = _("Your POKéMON is staring at\nthe mountaintop.");
static const u8 sCondMsg08[] = _("Sniff sniff, it smells something delicious!");
static const u8 sCondMsg09[] = _("Your POKéMON is eyeing the\nshelves restlessly.");
static const u8 sCondMsg10[] = _("{STR_VAR_1} is staring at\nthe shelves.");
static const u8* const sShopTexts[] = {sCondMsg09, sCondMsg10, NULL};
static const u8 sCondMsg11[] = _("{STR_VAR_1} fixed its gaze intently!");
...
static const u8 sCondMsg14[] = _("{STR_VAR_1} sways with\nthe ship!");
static const u8 sCondMsg15[] = _("{STR_VAR_1} dances along with\nthe rocking of the ship.");
...
static const u8 sCondMsg18[] = _("WOW! Your POKéMON splashed you\nwith water!");
static const u8 sCondMsg19[] = _("Your POKéMON is blowing sand\ninto the air!");
static const u8 sCondMsg20[] = _("{STR_VAR_1} is playing,\npulling up bits of grass.");
static const u8 sCondMsg21[] = _("Your POKéMON happily watches\nyour footprints!");
static const u8 sCondMsg22[] = _("{STR_VAR_1} feels nervous and a\nlittle cooped up.");
static const u8 sCondMsg23[] = _("{STR_VAR_1} moves carefully\nin the cramped space!");
static const u8* const sElevatorTexts[] = {sCondMsg22, sCondMsg23, NULL};
static const u8 sCondMsg24[] = _("A cold wind suddenly blew!");
static const u8 sCondMsg25[] = _("Your POKéMON almost slipped and fell!");
static const u8 sCondMsg26[] = _("Your POKéMON seems startled touching the ice.");
static const u8* const sColdTexts[] = {sCondMsg24, sCondMsg25, sCondMsg26, NULL};
static const u8 sCondMsg27[] = _("Your POKéMON has a flower\npetal on its face!");
...
static const u8 sCondMsg31[] = _("{STR_VAR_1} is sheltering from the\nrain in the grass.");
static const u8 sCondMsg32[] = _("{STR_VAR_1} seems very cold.");
static const u8 sCondMsg33[] = _("{STR_VAR_1} is looking at the sea.");
static const u8 sCondMsg34[] = _("Your POKéMON is staring at the sea!");
static const u8 sCondMsg35[] = _("{STR_VAR_1} is gazing at the\nchoppy sea.");
...
static const u8 sCondMsg37[] = _("{STR_VAR_1} seems happy in\nthe rain.");
static const u8 sCondMsg38[] = _("{STR_VAR_1} is looking at its\nreflection in the water.");
static const u8 sCondMsg39[] = _("{STR_VAR_1} seems to relax\nhearing the rustle of the leaves…");
static const u8 sCondMsg40[] = _("{STR_VAR_1} is biting the ice.");
...
static const u8 sCondMsg44[] = _("{STR_VAR_1} is looking up at\nthe sky.");
static const u8* const sDayTexts[] = {sCondMsg43, sCondMsg44, NULL};
static const u8 sCondMsg45[] = _("Your POKéMON gazes, fascinated,\nat the night sky!");
static const u8 sCondMsg46[] = _("Your POKéMON happily gazes\nat the beautiful starry sky!");
static const u8* const sNightTexts[] = {sCondMsg45, sCondMsg46, NULL};
static const u8 sCondMsg50[] = _("{STR_VAR_1} is unsettled by the\nabnormal weather!");
