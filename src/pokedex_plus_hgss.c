...
static const u8 sText_Stats_CatchRate_VeryHard[] = _(" {UP_ARROW} Hard");
static const u8 sText_Stats_CatchRate_Difficult[] = _("   Hard");
...
static const u8 sText_EVO_FRIENDSHIP[] = _("{UP_ARROW}{LV}, high friendship."); // POR CAMBIAR
static const u8 sText_EVO_FRIENDSHIP_DAY[] = _("{UP_ARROW}{LV}, high friendship, day."); // POR CAMBIAR
static const u8 sText_EVO_FRIENDSHIP_NIGHT[] = _("{UP_ARROW}{LV}, high friendship, night."); // POR CAMBIAR
static const u8 sText_EVO_FRIENDSHIP_MOVE_TYPE[] = _("{UP_ARROW}{LV}, high friendship, move {STR_VAR_2}."); // POR CAMBIAR
static const u8 sText_EVO_LEVEL[] = _("{UP_ARROW}{LV} a {STR_VAR_2}."); // POR CAMBIAR
static const u8 sText_EVO_TRADE[] = _("Trade."); // POR CAMBIAR
static const u8 sText_EVO_TRADE_ITEM[] = _("Trade holding {STR_VAR_2}."); // POR CAMBIAR
static const u8 sText_EVO_ITEM[] = _("Use {STR_VAR_2}."); // POR CAMBIAR
...
static const u8 sText_EVO_LEVEL_SHEDINJA[] = _("{UP_ARROW}{LV} to {STR_VAR_2}, party<6, 1x POKé BALL."); // POR CAMBIAR
static const u8 sText_EVO_BEAUTY[] = _("{UP_ARROW}{LV}, high beauty."); // POR CAMBIAR
static const u8 sText_EVO_LEVEL_FEMALE[] = _("{UP_ARROW}{LV} to {STR_VAR_2}, if female."); // POR CAMBIAR
static const u8 sText_EVO_LEVEL_MALE[] = _("{UP_ARROW}{LV} a {STR_VAR_2}, si chico."); // POR CAMBIAR
static const u8 sText_EVO_LEVEL_NIGHT[] = _("{UP_ARROW}{LV} to {STR_VAR_2}, night."); // POR CAMBIAR
static const u8 sText_EVO_LEVEL_DAY[] = _("{UP_ARROW}{LV} to {STR_VAR_2}, day."); // POR CAMBIAR
static const u8 sText_EVO_LEVEL_DUSK[] = _("{UP_ARROW}{LV} to {STR_VAR_2}, evening."); // POR CAMBIAR
static const u8 sText_EVO_ITEM_HOLD_DAY[] = _("{UP_ARROW}{LV} holding {STR_VAR_2}, day."); // POR CAMBIAR
static const u8 sText_EVO_ITEM_HOLD_NIGHT[] = _("{UP_ARROW}{LV} holding {STR_VAR_2}, night."); // POR CAMBIAR
...
static const u8 sText_EVO_ITEM_FEMALE[] = _("{STR_VAR_2} if female."); // POR CAMBIAR
static const u8 sText_EVO_LEVEL_RAIN[] = _("{LV}{UP_ARROW} to {STR_VAR_2} while raining");
static const u8 sText_EVO_SPECIFIC_MON_IN_PARTY[] = _("{UP_ARROW}{LV} with {STR_VAR_2} in party."); // POR CAMBIAR
static const u8 sText_EVO_LEVEL_DARK_TYPE_MON_IN_PARTY[] = _("{UP_ARROW}{LV} with a Dark-type in party."); // POR CAMBIAR
static const u8 sText_EVO_TRADE_SPECIFIC_MON[] = _("Trade for {STR_VAR_2}."); // POR CAMBIAR
static const u8 sText_EVO_SPECIFIC_MAP[] = _("{UP_ARROW}{LV} en {STR_VAR_2}."); // POR CAMBIAR
static const u8 sText_EVO_LEVEL_NATURE_AMPED[] = _("{UP_ARROW}{LV} to {STR_VAR_2}, sharp nature."); // POR CAMBIAR
static const u8 sText_EVO_LEVEL_NATURE_LOW_KEY[] = _("{UP_ARROW}{LV} to {STR_VAR_2}, grave nature."); // POR CAMBIAR
static const u8 sText_EVO_CRITICAL_HITS[] = _("Lands {STR_VAR_2} critical hits\nin one battle.");
static const u8 sText_EVO_SCRIPT_TRIGGER_DMG[] = _("After taking {STR_VAR_2} HP of damage.");
...
static const u8 sText_EVO_ITEM_NIGHT[] = _("Using {STR_VAR_2} at night."); // POR CAMBIAR
static const u8 sText_EVO_ITEM_DAY[] = _("Using {STR_VAR_2} in the day."); // POR CAMBIAR
static const u8 sText_EVO_ITEM_HOLD[] = _("{UP_ARROW}{LV}, holding {STR_VAR_2}."); // POR CAMBIAR
static const u8 sText_EVO_USE_MOVE_TWENTY_TIMES[] = _("{UP_ARROW}{LV} after using {STR_VAR_2} 20x.");
static const u8 sText_EVO_RECOIL_DAMAGE_MALE[] = _("{UP_ARROW}{LV} with {STR_VAR_2} recoil damage, ♂.");
static const u8 sText_EVO_RECOIL_DAMAGE_FEMALE[] = _("{UP_ARROW}{LV} with {STR_VAR_2} recoil damage, ♀.");
static const u8 sText_EVO_ITEM_COUNT_999[] = _("{UP_ARROW}{LV} with 999 {STR_VAR_2} in Bag."); // POR CAMBIAR
static const u8 sText_EVO_UNKNOWN[] = _("Unknown method."); // POR CAMBIAR
...
static const u8 sText_EVO_OVERWORLD_STEPS[] = _("{UP_ARROW}{LV} after {STR_VAR_2} steps."); // POR CAMBIAR
