...
const u32 gPartyMenuBgWah_Gfx[] = INCBIN_U32("graphics/party_menu/bg_wah.4bpp.smol");
const u32 gPartyMenuBgWah_Tilemap[] = INCBIN_U32("graphics/party_menu/bg_wah.bin.smolTM");
