...
static const u16 sQRPal[] = INCBIN_U16("graphics/field_pics/qr.gbapal");
static const u32 sPicWahQR[] = INCBIN_U32("graphics/field_pics/wah_qr.4bpp.lz");
...
static const struct Pic sPics[] =
{
    ...
    [FP_MAD_QR] = {sPicMadQR, sQRPal, SPRITE_SHAPE(64x64), SPRITE_SIZE(64x64), NULL},
    [FP_WAH_QR] = {sPicWahQR, sQRPal, SPRITE_SHAPE(64x64), SPRITE_SIZE(64x64), NULL},
};
