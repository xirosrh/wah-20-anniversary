...
{
    {
        .trainerId = TRAINER_WAH_ADMIN_EING_MAIN,
        .unused = 0,
    ...
    {
        .trainerId = TRAINER_WAH_ADMIN_JAVS_MAIN,
        .unused = 0,
        .battleTopicTextIds = BATTLE_TEXT_IDS(12),
    ...
    {
        .trainerId = TRAINER_WAH_COLLABORATOR_GOSUTO,
        .unused = 0,
    ...
    {
        .trainerId = TRAINER_WAH_ADMIN_SAYER_MAIN,
        .unused = 0,
        .battleTopicTextIds = BATTLE_TEXT_IDS(8),
    ...
    {
        .trainerId = TRAINER_WAH_ADMIN_CHEVE_MAIN,
        .unused = 0,
        // Thalia and Sawyer are the only ones who use different msg ids for their battle topics
