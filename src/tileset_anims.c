...
const u16 gTilesetAnims_RoomBoo_Torch_Frame0[] = INCBIN_U16("data/tilesets/secondary/room_boo/anim/torch/00.4bpp");
const u16 gTilesetAnims_RoomBoo_Torch_Frame1[] = INCBIN_U16("data/tilesets/secondary/room_boo/anim/torch/01.4bpp");
const u16 gTilesetAnims_RoomBoo_Torch_Frame2[] = INCBIN_U16("data/tilesets/secondary/room_boo/anim/torch/02.4bpp");
const u16 gTilesetAnims_RoomBoo_Torch_Frame3[] = INCBIN_U16("data/tilesets/secondary/room_boo/anim/torch/03.4bpp");


const u16 *const gTilesetAnims_RoomBoo_Torch[] = {
    gTilesetAnims_RoomBoo_Torch_Frame0,
    gTilesetAnims_RoomBoo_Torch_Frame1,
    gTilesetAnims_RoomBoo_Torch_Frame2,
    gTilesetAnims_RoomBoo_Torch_Frame3
};

static void QueueAnimTiles_RoomBoo_Torch(u16 timer)
{
    u16 i = timer % ARRAY_COUNT(gTilesetAnims_RoomBoo_Torch);
    AppendTilesetAnimToBuffer(gTilesetAnims_RoomBoo_Torch[i], (u16 *)(BG_VRAM + TILE_OFFSET_4BPP(NUM_TILES_IN_PRIMARY + 0)), 4 * TILE_SIZE_4BPP);
}

static void TilesetAnim_RoomBoo(u16 timer)
{
    if (timer % 16 == 0) {
        QueueAnimTiles_RoomBoo_Torch(timer / 16);
    }
}
...
const u16 gTilesetAnims_AngelRoom_Screen_FrameJessieJames2[] = INCBIN_U16("data/tilesets/secondary/room_angel/anim/screen/05.4bpp");
const u16 gTilesetAnims_AngelRoom_Screen_FrameBlueLegend[] = INCBIN_U16("data/tilesets/secondary/room_angel/anim/screen/01.4bpp");
...
const u16 *const gTilesetAnims_AngelRoom_Screen_FourthPart[] = {
    ...
    gTilesetAnims_AngelRoom_Screen_FrameHoennAdventuresDelta,
    gTilesetAnims_AngelRoom_Screen_FrameBlueLegend,
    gTilesetAnims_AngelRoom_Screen_FrameBlueLegend,
};

const u16 *const gTilesetAnims_AngelRoom_Screen_FifthPart[] = {
    gTilesetAnims_AngelRoom_Screen_FrameJessieJames2,
    gTilesetAnims_AngelRoom_Screen_FrameJessieJames2,
    gTilesetAnims_AngelRoom_Screen_FrameJessieJames2, //Unused
    gTilesetAnims_AngelRoom_Screen_FrameJessieJames2, //Unused
};
...
static void QueueAnimTiles_AngelRoom_Screen_FifthPart(u16 timer)
{
    u16 i = timer % ARRAY_COUNT(gTilesetAnims_AngelRoom_Screen_FifthPart);
    AppendTilesetAnimToBuffer(gTilesetAnims_AngelRoom_Screen_FifthPart[i], (u16 *)(BG_VRAM + TILE_OFFSET_4BPP(NUM_TILES_IN_PRIMARY + 0)), 7 * TILE_SIZE_4BPP);
}
...
const u16 gTilesetAnims_AngelRoom_Trailer_FrameJessieJames2[] = INCBIN_U16("data/tilesets/secondary/room_angel/anim/trailer/08.4bpp");
const u16 gTilesetAnims_AngelRoom_Trailer_FrameBlueLegend[] = INCBIN_U16("data/tilesets/secondary/room_angel/anim/trailer/09.4bpp");
...
const u16 *const gTilesetAnims_AngelRoom_Trailer_FourthPart[] = {
    ...
    gTilesetAnims_AngelRoom_Trailer_FrameEmpty, 
    gTilesetAnims_AngelRoom_Trailer_FrameBlueLegend,
};
...
const u16 *const gTilesetAnims_AngelRoom_Trailer_FifthPart[] = {
    gTilesetAnims_AngelRoom_Trailer_FrameEmpty,
    gTilesetAnims_AngelRoom_Trailer_FrameJessieJames2,
    gTilesetAnims_AngelRoom_Trailer_FrameEmpty,
    gTilesetAnims_AngelRoom_Trailer_FrameJessieJames2, //Unused
};

static void QueueAnimTiles_AngelRoom_Trailer_FifthPart(u16 timer)
{
    u16 i = timer % ARRAY_COUNT(gTilesetAnims_AngelRoom_Trailer_FifthPart);
    AppendTilesetAnimToBuffer(gTilesetAnims_AngelRoom_Trailer_FifthPart[i], (u16 *)(BG_VRAM + TILE_OFFSET_4BPP(NUM_TILES_IN_PRIMARY + 7)), 70 * TILE_SIZE_4BPP);
}
...
static void TilesetAnim_AngelRoom(u16 timer)
{
    ...
    if (timer % 64 == 0) 
    {
        ...
        else if(tilesIncrement < 18)
        {
            QueueAnimTiles_AngelRoom_Trailer_FifthPart(tilesIncrement - 16);
            QueueAnimTiles_AngelRoom_Screen_FifthPart(tilesIncrement - 16);
            tilesIncrement++;
            if(tilesIncrement >= 18)
            {
                tilesIncrement = 0;
            }
            VarSet(VAR_ANGEL_ROOM_TRAILER_FRAMES, tilesIncrement);
...
const u16 gTilesetAnims_DragonMountain2_Flag_Frame3[] = INCBIN_U16("data/tilesets/secondary/dragon_mountain_2/anim/flag/03.4bpp");
const u16 gTilesetAnims_DragonMountain2_Flag_Frame4[] = INCBIN_U16("data/tilesets/secondary/dragon_mountain_2/anim/flag/04.4bpp");
const u16 gTilesetAnims_DragonMountain2_Flag_Frame5[] = INCBIN_U16("data/tilesets/secondary/dragon_mountain_2/anim/flag/05.4bpp");
const u16 gTilesetAnims_DragonMountain2_Flag_Frame6[] = INCBIN_U16("data/tilesets/secondary/dragon_mountain_2/anim/flag/06.4bpp");
const u16 gTilesetAnims_DragonMountain2_Flag_Frame7[] = INCBIN_U16("data/tilesets/secondary/dragon_mountain_2/anim/flag/07.4bpp");
...
const u16 *const gTilesetAnims_DragonMountain2_Flag[] = {
    ...
    gTilesetAnims_DragonMountain2_Flag_Frame3,
    gTilesetAnims_DragonMountain2_Flag_Frame4,
    gTilesetAnims_DragonMountain2_Flag_Frame5,
    gTilesetAnims_DragonMountain2_Flag_Frame6,
    gTilesetAnims_DragonMountain2_Flag_Frame7,
};
