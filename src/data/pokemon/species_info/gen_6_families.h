...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_CHESPIN] =
    {
        ...
        .height = 4,
        .weight = 90,
		.description = COMPOUND_STRING("The quills on its head are usually soft.\n"
    ...
    [SPECIES_QUILLADIN] =
    {
        ...
        .height = 7,
        .weight = 290,
		.description = COMPOUND_STRING("They strengthen the sturdy shell covering\n"
    ...
    [SPECIES_CHESNAUGHT] =
    {
        ...
        .height = 16,
        .weight = 900,
		.description = COMPOUND_STRING("It shields its allies from danger with\n"
    ...
    [SPECIES_FENNEKIN] =
    {
        ...
        .height = 4,
        .weight = 94,
		.description = COMPOUND_STRING("As it walks, it munches on a twig to fill\n"
    ...
    [SPECIES_BRAIXEN] =
    {
        ...
        .height = 10,
        .weight = 145,
		.description = COMPOUND_STRING("Braixen has a twig stuck in its tail.\n"
    ...
    [SPECIES_DELPHOX] =
    {
        ...
        .height = 15,
        .weight = 390,
		.description = COMPOUND_STRING("It gazes into the flame at the tip of its\n"
    ...
    [SPECIES_FROAKIE] =
    {
        ...
        .height = 3,
        .weight = 70,
		.description = COMPOUND_STRING("It protects its skin by covering its body\n"
    ...
    [SPECIES_FROGADIER] =
    {
        ...
        .height = 6,
        .weight = 109,
		.description = COMPOUND_STRING("It can throw bubble-covered pebbles with\n"
    ...
    [SPECIES_BUNNELBY] =
    {
        ...
        .height = 4,
        .weight = 50,
		.description = COMPOUND_STRING("It has ears like shovels. Digging holes\n"
    ...
    [SPECIES_DIGGERSBY] =
    {
        ...
        .height = 10,
        .weight = 424,
		.description = COMPOUND_STRING("With its powerful ears it reduces dense\n"
    ...
    [SPECIES_FLETCHINDER] =
    {
        ...
        .height = 7,
        .weight = 160,
		.description = COMPOUND_STRING("From its beak, it expels embers that set\n"
    ...
    [SPECIES_TALONFLAME] =
    {
        ...
        .height = 12,
        .weight = 245,
		.description = COMPOUND_STRING("In the fever of an exciting battle, it\n"
...
#define VIVILLON_MISC_INFO(form, color, iconPal)                                            \
    ...
    [SPECIES_LITLEO] =
    {
        ...
        .height = 6,
        .weight = 135,
		.description = COMPOUND_STRING("They set off on their own from their pride\n"
    ...
    [SPECIES_PYROAR] =
    {
        ...
        .height = 15,
        .weight = 815,
		.description = COMPOUND_STRING("The male with the largest mane of fire\n"
...
#define FLORGES_MISC_INFO(Form, iconPal)                                        \
    ...
    [SPECIES_FLORGES_RED] =
    {
        ...
        .description = COMPOUND_STRING("This Pokémon creates an impressive\n"
    ...
    [SPECIES_SKIDDO] =
    {
        ...
        .height = 9,
        .weight = 310,
		.description = COMPOUND_STRING("If it has sunshine and water, it doesn't\n"
    ...
    [SPECIES_GOGOAT] =
    {
        ...
        .height = 17,
        .weight = 910,
		.description = COMPOUND_STRING("It can tell how its trainer is feeling by\n"
    ...
    [SPECIES_PANCHAM] =
    {
        ...
        .height = 6,
        .weight = 80,
		.description = COMPOUND_STRING("There's no point to the leaf in its mouth,\n"
    ...
    [SPECIES_PANGORO] =
    {
        ...
        .height = 21,
        .weight = 1360,
		.description = COMPOUND_STRING("It boasts superb physical strength.\n"
...
#define FURFROU_MISC_INFO(_form, _noFlip, frontWidth, frontYOffset, backWidth, backYOffset, _iconIdx)   \
    ...
    [SPECIES_ESPURR] =
    {
        ...
        .height = 3,
        .weight = 35,
		.description = COMPOUND_STRING("It has enough psychic energy to blast\n"
    ...
    [SPECIES_HONEDGE] =
    {
        ...
        .height = 8,
        .weight = 20,
		.description = COMPOUND_STRING("If anyone dares to grab its hilt, it\n"
    ...
    [SPECIES_DOUBLADE] =
    {
        ...
        .height = 8,
        .weight = 45,
		.description = COMPOUND_STRING("When Honedge evolves, it divides into\n"
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_SPRITZEE] =
    {
        ...
        .height = 2,
        .weight = 5,
		.description = COMPOUND_STRING("In the past, rather than using perfume,\n"
    ...
    [SPECIES_AROMATISSE] =
    {
        ...
        .height = 8,
        .weight = 155,
		.description = COMPOUND_STRING("Its scent is so overpowering that,\n"
    ...
    [SPECIES_SWIRLIX] =
    {
        ...
        .height = 4,
        .weight = 35,
		.description = COMPOUND_STRING("Because it eats nothing but sweets, its\n"
    ...
    [SPECIES_SLURPUFF] =
    {
        ...
        .height = 8,
        .weight = 50,
		.description = COMPOUND_STRING("Slurpuff can distinguish even the\n"
    ...
    [SPECIES_INKAY] =
    {
        ...
        .height = 4,
        .weight = 35,
		.description = COMPOUND_STRING("It flashes the light-emitting spots on its\n"
    ...
    [SPECIES_MALAMAR] =
    {
        ...
        .height = 15,
        .weight = 470,
		.description = COMPOUND_STRING("It lures prey close with hypnotic motions,\n"
    ...
    [SPECIES_BINACLE] =
    {
        ...
        .height = 5,
        .weight = 310,
		.description = COMPOUND_STRING("They stretch and then contract, yanking\n"
    ...
    [SPECIES_BARBARACLE] =
    {
        ...
        .height = 13,
        .weight = 960,
		.description = COMPOUND_STRING("Barbaracle's legs and hands have minds\n"
    ...
    [SPECIES_SKRELP] =
    {
        ...
        .height = 5,
        .weight = 73,
		.description = COMPOUND_STRING("Camouflaged as rotten kelp, it hides\n"
    ...
    [SPECIES_DRAGALGE] =
    {
        ...
        .height = 18,
        .weight = 815,
		.description = COMPOUND_STRING("Their poison is strong enough to eat\n"
    ...
    [SPECIES_CLAUNCHER] =
    {
        ...
        .height = 5,
        .weight = 83,
		.description = COMPOUND_STRING("Through controlled expulsions of internal\n"
    ...
    [SPECIES_CLAWITZER] =
    {
        ...
        .height = 13,
        .weight = 353,
		.description = COMPOUND_STRING("By expelling water from the nozzle in the\n"
    ...
    [SPECIES_HELIOPTILE] =
    {
        ...
        .height = 5,
        .weight = 60,
		.description = COMPOUND_STRING("They make their home in deserts.\n"
    ...
    [SPECIES_HELIOLISK] =
    {
        ...
        .height = 10,
        .weight = 210,
		.description = COMPOUND_STRING("A single Heliolisk can generate sufficient\n"
    ...
    [SPECIES_TYRUNT] =
    {
        ...
        .height = 8,
        .weight = 260,
		.description = COMPOUND_STRING("Its immense jaws have enough destructive\n"
    ...
    [SPECIES_TYRANTRUM] =
    {
        ...
        .height = 25,
        .weight = 2700,
		.description = COMPOUND_STRING("Thanks to its gargantuan jaws, which could\n"
    ...
    [SPECIES_AMAURA] =
    {
        ...
        .height = 13,
        .weight = 252,
		.description = COMPOUND_STRING("This ancient Pokémon was restored from\n"
    ...
    [SPECIES_AURORUS] =
    {
        ...
        .height = 27,
        .weight = 2250,
		.description = COMPOUND_STRING("Using the diamond-shaped crystals on its\n"
    ...
    [SPECIES_HAWLUCHA] =
    {
        ...
        .height = 8,
        .weight = 215,
		.description = COMPOUND_STRING("With its wings, it controls its position in\n"
    ...
    [SPECIES_DEDENNE] =
    {
        ...
        .height = 2,
        .weight = 22,
		.description = COMPOUND_STRING("Its whiskers serve as antennas.\n"
    ...
    [SPECIES_CARBINK] =
    {
        ...
        .height = 3,
        .weight = 57,
		.description = COMPOUND_STRING("Born from the high temperatures and\n"
    ...
    [SPECIES_GOOMY] =
    {
        ...
        .height = 3,
        .weight = 28,
		.description = COMPOUND_STRING("Its source of protection is its slimy,\n"
    ...
    [SPECIES_SLIGGOO] =
    {
        ...
        .height = 8,
        .weight = 175,
		.description = COMPOUND_STRING("This Pokémon's mucous can dissolve\n"
    ...
    [SPECIES_GOODRA] =
    {
        ...
        .height = 20,
        .weight = 1505,
		.description = COMPOUND_STRING("It gets picked on because it's meek.\n"
    ...
    [SPECIES_GOODRA_HISUI] =
    {
        ...
        .height = 17,
        .weight = 3341,
        .description = COMPOUND_STRING("It loathes solitude and is extremely\n"
    ...
    [SPECIES_KLEFKI] =
    {
        ...
        .height = 2,
        .weight = 30,
		.description = COMPOUND_STRING("These key collectors threaten any\n"
    ...
    [SPECIES_PHANTUMP] =
    {
        ...
        .height = 4,
        .weight = 70,
		.description = COMPOUND_STRING("According to legend, medicine to cure\n"
    ...
    [SPECIES_TREVENANT] =
    {
        ...
        .height = 15,
        .weight = 710,
		.description = COMPOUND_STRING("Through its roots, it exerts control over\n"
    ...
    [SPECIES_BERGMITE] =
    {
        ...
        .height = 10,
        .weight = 995,
		.description = COMPOUND_STRING("It blocks opponents' attacks with the ice\n"
    ...
    [SPECIES_NOIBAT] =
    {
        ...
        .height = 5,
        .weight = 80,
		.description = COMPOUND_STRING("They live in pitch-black caves. Even a\n"
    ...
    [SPECIES_NOIVERN] =
    {
        ...
        .height = 15,
        .weight = 850,
		.description = COMPOUND_STRING("They fly around on moonless nights and\n"
    ...
    [SPECIES_YVELTAL] =
    {
        ...
        .height = 58,
        .weight = 2030,
		.description = COMPOUND_STRING("When its life comes to an end, its wings\n"
    ...
    [SPECIES_DIANCIE] =
    {
        ...
        .height = 7,
        .weight = 88,
		.description = COMPOUND_STRING("A sudden transformation of Carbink,\n"
    ...
    [SPECIES_DIANCIE_MEGA] =
    {
        ...
        .height = 11,
        .weight = 278,
        .description = COMPOUND_STRING("The impurities upon its body's surface\n"
    ...
    [SPECIES_HOOPA_CONFINED] =
    {
        ...
        .height = 5,
        .weight = 90,
        .description = COMPOUND_STRING("In its true form, it possess a huge amount\n"
    ...
    [SPECIES_HOOPA_UNBOUND] =
    {
        ...
        .height = 65,
        .weight = 490,
        .description = COMPOUND_STRING("It is the true form of Hoopa, which has had\n"
    ...
    [SPECIES_VOLCANION] =
    {
        ...
        .height = 17,
        .weight = 1950,
		.description = COMPOUND_STRING("It lets out billows of steam from the arms\n"
