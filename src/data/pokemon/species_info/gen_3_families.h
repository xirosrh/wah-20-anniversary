...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_TREECKO] =
    {
        ...
        .height = 5,
        .weight = 50,
		.description = COMPOUND_STRING("It makes its nest in a giant tree in the\n"
    ...
    [SPECIES_GROVYLE] =
    {
        ...
        .height = 9,
        .weight = 216,
		.description = COMPOUND_STRING("Leaves grow out of this Pokémon's body.\n"
    ...
    [SPECIES_SCEPTILE] =
    {
        ...
        .height = 17,
        .weight = 522,
		.description = COMPOUND_STRING("In the jungle, its power is without equal.\n"
    ...
    [SPECIES_TORCHIC] =
    {
        ...
        .height = 4,
        .weight = 25,
		.description = COMPOUND_STRING("If attacked, it strikes back by spitting\n"
    ...
    [SPECIES_COMBUSKEN] =
    {
        ...
        .height = 9,
        .weight = 195,
		.description = COMPOUND_STRING("It lashes out with 10 kicks per second.\n"
    ...
    [SPECIES_BLAZIKEN] =
    {
        ...
        .height = 19,
        .weight = 520,
		.description = COMPOUND_STRING("It learns martial arts that use punches\n"
    ...
    [SPECIES_MUDKIP] =
    {
        ...
        .height = 4,
        .weight = 76,
		.description = COMPOUND_STRING("On land, it can powerfully lift large\n"
    ...
    [SPECIES_MARSHTOMP] =
    {
        ...
        .height = 7,
        .weight = 280,
		.description = COMPOUND_STRING("Its toughened hind legs enable it to stand\n"
    ...
    [SPECIES_SWAMPERT] =
    {
        ...
        .height = 15,
        .weight = 819,
		.description = COMPOUND_STRING("If it senses the approach of a storm and\n"
    ...
    [SPECIES_POOCHYENA] =
    {
        ...
        .height = 5,
        .weight = 136,
		.description = COMPOUND_STRING("It savagely threatens foes with bared\n"
    ...
    [SPECIES_MIGHTYENA] =
    {
        ...
        .height = 10,
        .weight = 370,
		.description = COMPOUND_STRING("In the wild, Mightyena live in a pack.\n"
    ...
    [SPECIES_ZIGZAGOON] =
    {
        ...
        .height = 4,
        .weight = 175,
		.description = COMPOUND_STRING("Rubbing its nose against the ground, it\n"
    ...
    [SPECIES_LINOONE] =
    {
        ...
        .height = 5,
        .weight = 325,
		.description = COMPOUND_STRING("It is exceedingly fast if it only has to run\n"
    ...
    [SPECIES_OBSTAGOON] =
    {
        ...
        .height = 16,
        .weight = 460,
		.description = COMPOUND_STRING("Its voice is staggering in volume.\n"
    ...
    [SPECIES_WURMPLE] =
    {
        ...
        .height = 3,
        .weight = 36,
		.description = COMPOUND_STRING("It sticks to tree branches and eats\n"
    ...
    [SPECIES_SILCOON] =
    {
        ...
        .height = 6,
        .weight = 100,
		.description = COMPOUND_STRING("It prepares for evolution using the\n"
    ...
    [SPECIES_BEAUTIFLY] =
    {
        ...
        .height = 10,
        .weight = 284,
		.description = COMPOUND_STRING("Its colorfully patterned wings are its\n"
    ...
    [SPECIES_CASCOON] =
    {
        ...
        .height = 7,
        .weight = 115,
		.description = COMPOUND_STRING("To avoid detection by its enemies, it hides\n"
    ...
    [SPECIES_DUSTOX] =
    {
        ...
        .height = 12,
        .weight = 316,
		.description = COMPOUND_STRING("It is a nocturnal Pokémon that flies from\n"
    ...
    [SPECIES_LOTAD] =
    {
        ...
        .height = 5,
        .weight = 26,
		.description = COMPOUND_STRING("This Pokémon lives in ponds with clean\n"
    ...
    [SPECIES_LOMBRE] =
    {
        ...
        .height = 12,
        .weight = 325,
		.description = COMPOUND_STRING("In the evening, it takes great delight in\n"
    ...
    [SPECIES_LUDICOLO] =
    {
        ...
        .height = 15,
        .weight = 550,
		.description = COMPOUND_STRING("When it hears festive music, all the cells\n"
    ...
    [SPECIES_SEEDOT] =
    {
        ...
        .height = 5,
        .weight = 40,
		.description = COMPOUND_STRING("It hangs off branches and absorbs\n"
    ...
    [SPECIES_NUZLEAF] =
    {
        ...
        .height = 10,
        .weight = 280,
		.description = COMPOUND_STRING("A forest-dwelling Pokémon that is skilled\n"
    ...
    [SPECIES_SHIFTRY] =
    {
        ...
        .height = 13,
        .weight = 596,
		.description = COMPOUND_STRING("It is said to arrive on chilly, wintry winds.\n"
    ...
    [SPECIES_TAILLOW] =
    {
        ...
        .height = 3,
        .weight = 23,
		.description = COMPOUND_STRING("Although it is small, it is very courageous.\n"
    ...
    [SPECIES_SWELLOW] =
    {
        ...
        .height = 7,
        .weight = 198,
		.description = COMPOUND_STRING("A Swellow dives upon prey from far above.\n"
    ...
    [SPECIES_WINGULL] =
    {
        ...
        .height = 6,
        .weight = 95,
		.description = COMPOUND_STRING("It makes its nest on a sheer cliff at the\n"
    ...
    [SPECIES_PELIPPER] =
    {
        ...
        .height = 12,
        .weight = 280,
		.description = COMPOUND_STRING("It skims the tops of waves as it flies.\n"
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_RALTS] =
    {
        ...
        .height = 4,
        .weight = 66,
		.description = COMPOUND_STRING("A Ralts has the power to sense the\n"
    ...
    [SPECIES_GARDEVOIR] =
    {
        ...
        .height = 16,
        .weight = 484,
		.description = COMPOUND_STRING("It apparently does not feel the pull of\n"
    ...
    [SPECIES_GALLADE] =
    {
        ...
        .height = 16,
        .weight = 520,
		.description = COMPOUND_STRING("A master of courtesy and swordsmanship,\n"
    ...
    [SPECIES_MASQUERAIN] =
    {
        ...
        .height = 8,
        .weight = 36,
		.description = COMPOUND_STRING("It intimidates foes with the large eyelike\n"
    ...
    [SPECIES_SHROOMISH] =
    {
        ...
        .height = 4,
        .weight = 45,
		.description = COMPOUND_STRING("It loves to eat damp, composted soil in\n"
    ...
    [SPECIES_BRELOOM] =
    {
        ...
        .height = 12,
        .weight = 392,
		.description = COMPOUND_STRING("It scatters spores from holes in the cap\n"
    ...
    [SPECIES_SLAKOTH] =
    {
        ...
        .height = 8,
        .weight = 240,
		.description = COMPOUND_STRING("It sleeps virtually all day and night long.\n"
    ...
    [SPECIES_VIGOROTH] =
    {
        ...
        .height = 14,
        .weight = 465,
		.description = COMPOUND_STRING("It can't keep still because its blood boils\n"
    ...
    [SPECIES_SLAKING] =
    {
        ...
        .height = 20,
        .weight = 1305,
		.description = COMPOUND_STRING("Hordes of Slaking gather around trees\n"
    ...
    [SPECIES_NINCADA] =
    {
        ...
        .height = 5,
        .weight = 55,
		.description = COMPOUND_STRING("It makes its nest at the roots of a mighty\n"
    ...
    [SPECIES_NINJASK] =
    {
        ...
        .height = 8,
        .weight = 120,
		.description = COMPOUND_STRING("Because it darts about vigorously at high\n"
    ...
    [SPECIES_SHEDINJA] =
    {
        ...
        .height = 8,
        .weight = 12,
		.description = COMPOUND_STRING("A peculiar Pokémon that floats in air even\n"
    ...
    [SPECIES_WHISMUR] =
    {
        ...
        .height = 6,
        .weight = 163,
		.description = COMPOUND_STRING("Its cries equal a jet plane in volume.\n"
    ...
    [SPECIES_LOUDRED] =
    {
        ...
        .height = 10,
        .weight = 405,
		.description = COMPOUND_STRING("It positions the round speakers on its\n"
    ...
    [SPECIES_EXPLOUD] =
    {
        ...
        .height = 15,
        .weight = 840,
		.description = COMPOUND_STRING("It has sound-generating organs all over\n"
    ...
    [SPECIES_MAKUHITA] =
    {
        ...
        .height = 10,
        .weight = 864,
		.description = COMPOUND_STRING("It loves to toughen up its body above all\n"
    ...
    [SPECIES_HARIYAMA] =
    {
        ...
        .height = 23,
        .weight = 2538,
		.description = COMPOUND_STRING("It has the habit of challenging others\n"
    ...
    [SPECIES_NOSEPASS] =
    {
        ...
        .height = 10,
        .weight = 970,
		.description = COMPOUND_STRING("Its body emits a powerful magnetism.\n"
    ...
    [SPECIES_PROBOPASS] =
    {
        ...
        .height = 14,
        .weight = 3400,
		.description = COMPOUND_STRING("It freely controls three units called\n"
    ...
    [SPECIES_SKITTY] =
    {
        ...
        .height = 6,
        .weight = 110,
		.description = COMPOUND_STRING("A Skitty's adorably cute behavior makes it\n"
    ...
    [SPECIES_DELCATTY] =
    {
        ...
        .height = 11,
        .weight = 326,
		.description = COMPOUND_STRING("Rather than keeping a permanent lair,\n"
    ...
    [SPECIES_SABLEYE] =
    {
        ...
        .height = 5,
        .weight = 110,
		.description = COMPOUND_STRING("It digs branching holes in caves using its\n"
    ...
    [SPECIES_MAWILE] =
    {
        ...
        .height = 6,
        .weight = 115,
		.description = COMPOUND_STRING("Its giant jaws are actually steel horns\n"
    ...
    [SPECIES_ARON] =
    {
        ...
        .height = 4,
        .weight = 600,
		.description = COMPOUND_STRING("A Pokémon that is clad in steel armor.\n"
    ...
    [SPECIES_LAIRON] =
    {
        ...
        .height = 9,
        .weight = 1200,
		.description = COMPOUND_STRING("When two Lairon meet in the wild, they\n"
    ...
    [SPECIES_AGGRON] =
    {
        ...
        .height = 21,
        .weight = 3600,
		.description = COMPOUND_STRING("Its iron horns grow longer a little at\n"
    ...
    [SPECIES_MEDITITE] =
    {
        ...
        .height = 6,
        .weight = 112,
		.description = COMPOUND_STRING("It continually meditates for hours every\n"
    ...
    [SPECIES_MEDICHAM] =
    {
        ...
        .height = 13,
        .weight = 315,
		.description = COMPOUND_STRING("Through crushingly harsh yoga training, it\n"
    ...
    [SPECIES_ELECTRIKE] =
    {
        ...
        .height = 6,
        .weight = 152,
		.description = COMPOUND_STRING("It generates electricity using friction\n"
    ...
    [SPECIES_MANECTRIC] =
    {
        ...
        .height = 15,
        .weight = 402,
		.description = COMPOUND_STRING("Because lightning falls in their vicinities,\n"
    ...
    [SPECIES_PLUSLE] =
    {
        ...
        .height = 4,
        .weight = 42,
		.description = COMPOUND_STRING("It has the trait of cheering on its fellow\n"
    ...
    [SPECIES_MINUN] =
    {
        ...
        .height = 4,
        .weight = 42,
		.description = COMPOUND_STRING("At a meeting of Pokémon academics, it was\n"
    ...
    [SPECIES_VOLBEAT] =
    {
        ...
        .height = 7,
        .weight = 177,
		.description = COMPOUND_STRING("With their taillights lit, Volbeat fly in\n"
    ...
    [SPECIES_ILLUMISE] =
    {
        ...
        .height = 6,
        .weight = 177,
		.description = COMPOUND_STRING("A nocturnal Pokémon that becomes active\n"
    ...
    [SPECIES_BUDEW] =
    {
        ...
        .height = 2,
        .weight = 12,
		.description = COMPOUND_STRING("Over the winter, it closes its bud and\n"
    ...
    [SPECIES_ROSELIA] =
    {
        ...
        .height = 3,
        .weight = 20,
		.description = COMPOUND_STRING("A Roselia that drinks nutritionally rich\n"
    ...
    [SPECIES_ROSERADE] =
    {
        ...
        .height = 9,
        .weight = 145,
		.description = COMPOUND_STRING("Its sweet aroma attracts prey.\n"
    ...
    [SPECIES_GULPIN] =
    {
        ...
        .height = 4,
        .weight = 103,
		.description = COMPOUND_STRING("This Pokémon's stomach fluid can even\n"
    ...
    [SPECIES_SWALOT] =
    {
        ...
        .height = 17,
        .weight = 800,
		.description = COMPOUND_STRING("Its powerful stomach acid is capable of\n"
    ...
    [SPECIES_CARVANHA] =
    {
        ...
        .height = 8,
        .weight = 208,
		.description = COMPOUND_STRING("Carvanha attack ships in swarms, making\n"
    ...
    [SPECIES_SHARPEDO] =
    {
        ...
        .height = 18,
        .weight = 888,
		.description = COMPOUND_STRING("The vicious and sly gangster of the sea.\n"
    ...
    [SPECIES_WAILMER] =
    {
        ...
        .height = 20,
        .weight = 1300,
		.description = COMPOUND_STRING("While this Pokémon usually lives in the sea,\n"
    ...
    [SPECIES_WAILORD] =
    {
        ...
        .height = 145,
        .weight = 3980,
		.description = COMPOUND_STRING("It breathes through nostrils that it\n"
    ...
    [SPECIES_NUMEL] =
    {
        ...
        .height = 7,
        .weight = 240,
		.description = COMPOUND_STRING("A Numel stores boiling magma in the hump\n"
    ...
    [SPECIES_CAMERUPT] =
    {
        ...
        .height = 19,
        .weight = 2200,
		.description = COMPOUND_STRING("A Pokémon that lives in the crater of\n"
    ...
    [SPECIES_TORKOAL] =
    {
        ...
        .height = 5,
        .weight = 804,
		.description = COMPOUND_STRING("It battles using energy it gets from\n"
    ...
    [SPECIES_SPOINK] =
    {
        ...
        .height = 7,
        .weight = 306,
		.description = COMPOUND_STRING("A Pokémon that manipulates psychic power\n"
    ...
    [SPECIES_GRUMPIG] =
    {
        ...
        .height = 9,
        .weight = 715,
		.description = COMPOUND_STRING("It stores power in the black pearls on its\n"
    ...
    [SPECIES_SPINDA] =
    {
        ...
        .height = 11,
        .weight = 50,
		.description = COMPOUND_STRING("It is distinguished by a pattern of\n"
    ...
    [SPECIES_TRAPINCH] =
    {
        ...
        .height = 7,
        .weight = 150,
		.description = COMPOUND_STRING("Its big jaws crunch through boulders.\n"
    ...
    [SPECIES_VIBRAVA] =
    {
        ...
        .height = 11,
        .weight = 153,
		.description = COMPOUND_STRING("It looses ultrasonic waves by rubbing its\n"
    ...
    [SPECIES_FLYGON] =
    {
        ...
        .height = 20,
        .weight = 820,
		.description = COMPOUND_STRING("The flapping of its wings sounds like\n"
    ...
    [SPECIES_CACNEA] =
    {
        ...
        .height = 4,
        .weight = 513,
		.description = COMPOUND_STRING("Cacnea live in deserts with virtually no\n"
    ...
    [SPECIES_CACTURNE] =
    {
        ...
        .height = 13,
        .weight = 774,
		.description = COMPOUND_STRING("After spending thousands of years in\n"
    ...
    [SPECIES_SWABLU] =
    {
        ...
        .height = 4,
        .weight = 12,
		.description = COMPOUND_STRING("A Pokémon that has wings like cottony\n"
    ...
    [SPECIES_ALTARIA] =
    {
        ...
        .height = 11,
        .weight = 206,
		.description = COMPOUND_STRING("It hums in a beautiful soprano voice.\n"
    ...
    [SPECIES_ZANGOOSE] =
    {
        ...
        .height = 13,
        .weight = 403,
		.description = COMPOUND_STRING("When it battles, it stands on its hind legs\n"
    ...
    [SPECIES_SEVIPER] =
    {
        ...
        .height = 27,
        .weight = 525,
		.description = COMPOUND_STRING("Seviper and Zangoose are eternal rivals.\n"
    ...
    [SPECIES_LUNATONE] =
    {
        ...
        .height = 10,
        .weight = 1680,
		.description = COMPOUND_STRING("It becomes very active on the night of\n"
    ...
    [SPECIES_BARBOACH] =
    {
        ...
        .height = 4,
        .weight = 19,
		.description = COMPOUND_STRING("Its body is covered with a slimy film.\n"
    ...
    [SPECIES_WHISCASH] =
    {
        ...
        .height = 9,
        .weight = 236,
		.description = COMPOUND_STRING("Mysteriously, it can foretell earthquakes.\n"
    ...
    [SPECIES_CORPHISH] =
    {
        ...
        .height = 6,
        .weight = 115,
		.description = COMPOUND_STRING("Once it grips prey with its large pincers,\n"
    ...
    [SPECIES_CRAWDAUNT] =
    {
        ...
        .height = 11,
        .weight = 328,
		.description = COMPOUND_STRING("A brutish Pokémon that loves to battle.\n"
    ...
    [SPECIES_BALTOY] =
    {
        ...
        .height = 5,
        .weight = 215,
		.description = COMPOUND_STRING("A Baltoy moves by spinning on its single\n"
    ...
    [SPECIES_CLAYDOL] =
    {
        ...
        .height = 15,
        .weight = 1080,
		.description = COMPOUND_STRING("A Claydol sleeps while hovering in midair.\n"
    ...
    [SPECIES_LILEEP] =
    {
        ...
        .height = 10,
        .weight = 238,
		.description = COMPOUND_STRING("It disguises itself as seaweed by making\n"
    ...
    [SPECIES_CRADILY] =
    {
        ...
        .height = 15,
        .weight = 604,
		.description = COMPOUND_STRING("It drags its heavy body along the\n"
    ...
    [SPECIES_ANORITH] =
    {
        ...
        .height = 7,
        .weight = 125,
		.description = COMPOUND_STRING("It was resurrected from a fossil using the\n"
    ...
    [SPECIES_ARMALDO] =
    {
        ...
        .height = 15,
        .weight = 682,
		.description = COMPOUND_STRING("Armaldo usually lives on land. However,\n"
    ...
    [SPECIES_FEEBAS] =
    {
        ...
        .height = 6,
        .weight = 74,
		.description = COMPOUND_STRING("Feebas live in ponds that are heavily\n"
    ...
    [SPECIES_MILOTIC] =
    {
        ...
        .height = 62,
        .weight = 1620,
		.description = COMPOUND_STRING("It is said to live at the bottom of\n"
    ...
    [SPECIES_CASTFORM_NORMAL] =
    {
        ...
        .height = 3,
        .weight = 8,
        .description = COMPOUND_STRING("It alters its form depending on the\n"
    ...
    [SPECIES_KECLEON] =
    {
        ...
        .height = 10,
        .weight = 220,
		.description = COMPOUND_STRING("A Pokémon that has the ability to alter its\n"
    ...
    [SPECIES_SHUPPET] =
    {
        ...
        .height = 6,
        .weight = 23,
		.description = COMPOUND_STRING("This Pokémon roams about deep in the\n"
    ...
    [SPECIES_BANETTE] =
    {
        ...
        .height = 11,
        .weight = 125,
		.description = COMPOUND_STRING("An abandoned plush doll became this\n"
    ...
    [SPECIES_DUSKULL] =
    {
        ...
        .height = 8,
        .weight = 150,
		.description = COMPOUND_STRING("A glare from its single scarlet eye makes\n"
    ...
    [SPECIES_DUSCLOPS] =
    {
        ...
        .height = 16,
        .weight = 306,
		.description = COMPOUND_STRING("It is thought that its body is hollow with\n"
    ...
    [SPECIES_DUSKNOIR] =
    {
        ...
        .height = 22,
        .weight = 1066,
		.description = COMPOUND_STRING("This feared Pokémon is said to travel to\n"
    ...
    [SPECIES_TROPIUS] =
    {
        ...
        .height = 20,
        .weight = 1000,
		.description = COMPOUND_STRING("It flies by flapping its broad leaves.\n"
    ...
    [SPECIES_CHINGLING] =
    {
        ...
        .height = 2,
        .weight = 6,
		.description = COMPOUND_STRING("There is an orb inside its mouth.\n"
    ...
    [SPECIES_CHIMECHO] =
    {
        ...
        .height = 6,
        .weight = 10,
		.description = COMPOUND_STRING("They fly about very actively when the hot\n"
    ...
    [SPECIES_ABSOL] =
    {
        ...
        .height = 12,
        .weight = 470,
		.description = COMPOUND_STRING("It sharply senses even subtle changes in\n"
    ...
    [SPECIES_SNORUNT] =
    {
        ...
        .height = 7,
        .weight = 168,
		.description = COMPOUND_STRING("They tend to move about in groups of\n"
    ...
    [SPECIES_GLALIE] =
    {
        ...
        .height = 15,
        .weight = 2565,
		.description = COMPOUND_STRING("A Glalie has the power to instantaneously\n"
    ...
    [SPECIES_FROSLASS] =
    {
        ...
        .height = 13,
        .weight = 266,
		.description = COMPOUND_STRING("When it finds people or Pokémon it likes,\n"
...
//      SHADOW(0, 0, SHADOW_SIZE_M)
    ...
    [SPECIES_SPHEAL] =
    {
        ...
        .height = 8,
        .weight = 395,
		.description = COMPOUND_STRING("It is completely covered with plushy fur.\n"
    ...
    [SPECIES_SEALEO] =
    {
        ...
        .height = 11,
        .weight = 876,
		.description = COMPOUND_STRING("Sealeo live in herds on ice floes. Using its\n"
    ...
    [SPECIES_WALREIN] =
    {
        ...
        .height = 14,
        .weight = 1506,
		.description = COMPOUND_STRING("To protect its herd, the leader battles\n"
    ...
    [SPECIES_CLAMPERL] =
    {
        ...
        .height = 4,
        .weight = 525,
		.description = COMPOUND_STRING("A Clamperl slams its shell closed on prey\n"
    ...
    [SPECIES_HUNTAIL] =
    {
        ...
        .height = 17,
        .weight = 270,
		.description = COMPOUND_STRING("To withstand the crushing pressure of\n"
    ...
    [SPECIES_GOREBYSS] =
    {
        ...
        .height = 18,
        .weight = 226,
		.description = COMPOUND_STRING("A Gorebyss siphons the body fluids of prey\n"
    ...
    [SPECIES_RELICANTH] =
    {
        ...
        .height = 10,
        .weight = 234,
		.description = COMPOUND_STRING("A Pokémon that was once believed to have\n"
    ...
    [SPECIES_LUVDISC] =
    {
        ...
        .height = 6,
        .weight = 87,
		.description = COMPOUND_STRING("Luvdisc make the branches of Corsola\n"
    ...
    [SPECIES_BAGON] =
    {
        ...
        .height = 6,
        .weight = 421,
		.description = COMPOUND_STRING("Although it is small, this Pokémon is very\n"
    ...
    [SPECIES_SALAMENCE] =
    {
        ...
        .height = 15,
        .weight = 1026,
		.description = COMPOUND_STRING("After many long years, its cellular\n"
    ...
    [SPECIES_BELDUM] =
    {
        ...
        .height = 6,
        .weight = 952,
		.description = COMPOUND_STRING("When Beldum gather in a swarm, they move\n"
    ...
    [SPECIES_METAGROSS] =
    {
        ...
        .height = 16,
        .weight = 5500,
		.description = COMPOUND_STRING("Metagross has four brains that are joined\n"
    ...
    [SPECIES_REGIROCK] =
    {
        ...
        .height = 17,
        .weight = 2300,
		.description = COMPOUND_STRING("A Pokémon that is made entirely of rocks\n"
    ...
    [SPECIES_REGICE] =
    {
        ...
        .height = 18,
        .weight = 1750,
		.description = COMPOUND_STRING("Its entire body is made of Antarctic ice.\n"
    ...
    [SPECIES_REGISTEEL] =
    {
        ...
        .height = 19,
        .weight = 2050,
		.description = COMPOUND_STRING("Its body is harder than any other kind of\n"
    ...
    [SPECIES_LATIAS] =
    {
        ...
        .height = 14,
        .weight = 400,
		.description = COMPOUND_STRING("They make a small herd of only several\n"
    ...
    [SPECIES_LATIOS] =
    {
        ...
        .height = 20,
        .weight = 600,
		.description = COMPOUND_STRING("Even in hiding, it can detect the locations\n"
    ...
    [SPECIES_KYOGRE] =
    {
        ...
        .height = 45,
        .weight = 3520,
		.description = COMPOUND_STRING("Kyogre has appeared in mythology as the\n"
    ...
    [SPECIES_GROUDON] =
    {
        ...
        .height = 35,
        .weight = 9500,
		.description = COMPOUND_STRING("Groudon has appeared in mythology as the\n"
    ...
    [SPECIES_RAYQUAZA] =
    {
        ...
        .height = 70,
        .weight = 2065,
		.description = COMPOUND_STRING("A Pokémon that flies endlessly in the\n"
    ...
    [SPECIES_JIRACHI] =
    {
        ...
        .height = 3,
        .weight = 11,
		.description = COMPOUND_STRING("Jirachi is said to make wishes come true.\n"
