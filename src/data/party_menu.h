...
static const struct WindowTemplate sDoublePartyMenuWindowTemplate[] =
{
    ...
    [WIN_MSG] = {
        ...
        .height = 4,
        .paletteNum = 14,
        .baseBlock = 0x21F, // Fix overlap with cancel button
    },
    DUMMY_WIN_TEMPLATE
};
...
static const u8 *const sActionStringTable[] =
{
    ...
    [PARTY_MSG_NO_POKEMON]             = COMPOUND_STRING("There is no Pokémon."),
...
} static const sCursorOptions[MENU_FIELD_MOVES] =
{
    ...
    [MENU_CATALOG_BULB]     = {COMPOUND_STRING("Bulb"),                 CursorCb_CatalogBulb},
    [MENU_CATALOG_OVEN]     = {COMPOUND_STRING("Oven"),                 CursorCb_CatalogOven},
    [MENU_CATALOG_WASHING]  = {COMPOUND_STRING("Washer"),               CursorCb_CatalogWashing},
    [MENU_CATALOG_FRIDGE]   = {COMPOUND_STRING("Refrigerator"),          CursorCb_CatalogFridge},
    [MENU_CATALOG_FAN]      = {COMPOUND_STRING("Fan"),                  CursorCb_CatalogFan},
    [MENU_CATALOG_MOWER]    = {COMPOUND_STRING("Lawnmower"),          CursorCb_CatalogMower},
    [MENU_CHANGE_FORM]      = {COMPOUND_STRING("Change Form"),          CursorCb_ChangeForm},
    [MENU_CHANGE_ABILITY]   = {COMPOUND_STRING("Change Abil."),     CursorCb_ChangeAbility},
};
