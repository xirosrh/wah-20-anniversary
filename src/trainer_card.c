...
static const u8 sTrainerCardTextColorsWhite[] = {TEXT_COLOR_TRANSPARENT, TEXT_COLOR_WHITE, TEXT_COLOR_DARK_GRAY};
...
static void PrintTaskOnCardBack()
{
    ...
    const u8 gText_CompletedTaskTrainerCard[] = _("Completed");
