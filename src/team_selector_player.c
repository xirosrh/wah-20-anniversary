...
const struct TeamSelectorMonData gAllTeamMons[NUM_MONS_POOL] =
{
    [MON_HITMONCHAN] = {
        ...
        .isShiny = FALSE,
        .moves = {MOVE_MACH_PUNCH, MOVE_BULLET_PUNCH, MOVE_DRAIN_PUNCH, MOVE_THUNDER_PUNCH},
    },
    [MON_BRONZONG] = {
    ...
    [MON_FORRETRESS] = {
        ...
        .isShiny = FALSE,
        .moves = {MOVE_STEALTH_ROCK, MOVE_SPIKES, MOVE_TOXIC_SPIKES, MOVE_RAPID_SPIN},
    },
    [MON_VICTREEBEL] = {
        ...
        .ev = TRAINER_PARTY_EVS(4, 252, 0, 252, 0, 0),
        .isShiny = FALSE,
        .moves = {MOVE_LEECH_LIFE, MOVE_POISON_JAB, MOVE_LEAF_BLADE, MOVE_KNOCK_OFF},
    },
    [MON_ARCANINE_HISUI] = {
    ...
    [MON_CONKELDURR] = {
        ...
        .ev = TRAINER_PARTY_EVS(4, 252, 0, 252, 0, 0),
        .isShiny = FALSE,
        .moves = {MOVE_MACH_PUNCH, MOVE_BULLET_PUNCH, MOVE_DRAIN_PUNCH, MOVE_DYNAMIC_PUNCH},
    },
    [MON_ALAKAZAM] = {
        ...
        .ev = TRAINER_PARTY_EVS(4, 0, 0, 252, 252, 0),
        .isShiny = FALSE,
        .moves = {MOVE_RECOVER, MOVE_PSYCHIC, MOVE_DAZZLING_GLEAM, MOVE_SHADOW_BALL},
    },
    [MON_WEAVILE] = {
        ...
        .ev = TRAINER_PARTY_EVS(4, 252, 0, 252, 0, 0),
        .isShiny = FALSE,
        .moves = {MOVE_FAKE_OUT, MOVE_KNOCK_OFF, MOVE_ICE_SHARD, MOVE_METAL_CLAW},
    },
    [MON_ALOLAN_MAROWAK] = {
    ...
    [MON_SLOWBRO] = {
        ...
        [MON_ZYGARDE] = {
            .specie = SPECIES_ZYGARDE_50_POWER_CONSTRUCT,
