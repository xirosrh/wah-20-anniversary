...
const struct Song gSongTable[] = 
{
    ...
    [MUS_TV_GOTTA_CATCH_EM_ALL]     = SONG(mus_TV_Gotta_Catch_Em_All, MUSIC_PLAYER_BGM),
    [MUS_TV_TOTAL_WAR]              = SONG(mus_TV_Total_War, MUSIC_PLAYER_BGM),
    ...
    [MUS_DP_VS_GALACTIC_BOSS]       = SONG(mus_dp_vs_galactic_boss, MUSIC_PLAYER_BGM),
    [MUS_DP_VS_GYM_LEADER]          = SONG(mus_dp_vs_gym_leader, MUSIC_PLAYER_BGM),
    [MUS_DP_VS_TRAINER]             = SONG(mus_dp_vs_trainer, MUSIC_PLAYER_BGM),
    [MUS_HG_VS_GYM_LEADER_KANTO]    = SONG(mus_hg_vs_gym_leader_kanto, MUSIC_PLAYER_BGM),
    [MUS_HG_VS_GYM_LEADER]          = SONG(mus_hg_vs_gym_leader, MUSIC_PLAYER_BGM),
    [MUS_HG_VS_RIVAL]               = SONG(mus_hg_vs_rival, MUSIC_PLAYER_BGM),
    [MUS_HG_VS_ROCKET]              = SONG(mus_hg_vs_rocket, MUSIC_PLAYER_BGM),
    [MUS_HG_VS_TRAINER]             = SONG(mus_hg_vs_trainer, MUSIC_PLAYER_BGM),
